...
return [
    ...
    'components' => Config::defaultComponents([
        'currency' => [
            'class' => App\Services\WireUiComponents\CustomInputCurrency::class,
        ...
        // ],
        'select' => [
            'class' => App\Services\WireUiComponents\CustomSelectBase::class,
            'alias' => 'select',
        ],
    ]),
];
